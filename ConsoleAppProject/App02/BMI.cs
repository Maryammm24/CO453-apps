...
namespace ConsoleAppProject.App02
{
    ...
    public class BMI
    {
        ...
        private void InputImperialValue()
        {
            ...
            Inches = (int)ConsoleHelper.InputNumber("--in Inches > ");
            Console.WriteLine("\nEnter your Weight:");
            Stones = (int)ConsoleHelper.InputNumber("--in Stones > ");
            Pounds = (int)ConsoleHelper.InputNumber("--in Pounds > ");
        }
        ...
        {
            Pounds += Stones * POUNDS_IN_STONES;
            Inches += Feet * INCH_IN_FEET;
            BmiIndex = (double)Pounds * 703 / (Inches * Inches);
        }
